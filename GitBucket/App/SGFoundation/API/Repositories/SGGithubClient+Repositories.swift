...
extension SGGithubClient {
    ...
    class func fetchRepositories(login: String? = nil, page: Int, completion: @escaping (_ repos: [SGRepository]?, _ nextPage: Int?, _ error: Error?) -> Void) {
    ...
    class func fetchRepositoriesForOrganization(_ org: String, page: Int, completion: @escaping (_ repos: [SGRepository]?, _ nextPage: Int?, _ error: Error?) -> Void) {
